                ...
                <div className="container mt-5 ">
                    <div className="row m-0 p-0">
                        ...
                        <div className="col-lg-6  ">
                            <p className="ps-5 text-dark">WELCOME</p>
                            <div className="mt-3 ms-5" style={{ border: "1px solid blue ", width: "34px" }}>
                            </div>

                            <p className="ps-5 mt-3" style={{ color: "#676767", fontSize: "15px", }}>
